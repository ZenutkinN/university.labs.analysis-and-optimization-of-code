...
define i32 @main() {
	...
	%3 = load i32, i32* %2, align 4
	%4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.d, i32 0, i32 0), i32 %3)
	%5 = alloca [2 x i8], align 1
	%6 = bitcast [2 x i8]* %5 to i8*
	call void @llvm.memcpy.p0i8.p0i8.i64(i8* %6, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.gVar.1, i32 0, i32 0), i64 2, i32 1, i1 false)
	%7 = getelementptr inbounds [2 x i8], [2 x i8]* %5, i32 0, i32 0
	%8 = alloca i8*, align 1
	store i8* %7, i8** %8, align 1
	%9 = load i8*, i8** %8, align 1
	%10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.s, i32 0, i32 0), i8* %9)
