...
define i32 @main() {
	...
	%13 = call i32 @test(i32 %9, i32 %12)
	%14 = alloca i32, align 4
	store i32 %13, i32* %14, align 4
	%15 = load i32, i32* %14, align 4
	%16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.d, i32 0, i32 0), i32 %15)
	%17 = alloca [2 x i8], align 1
	%18 = bitcast [2 x i8]* %17 to i8*
	call void @llvm.memcpy.p0i8.p0i8.i64(i8* %18, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.gVar.1, i32 0, i32 0), i64 2, i32 1, i1 false)
	%19 = getelementptr inbounds [2 x i8], [2 x i8]* %17, i32 0, i32 0
	%20 = alloca i8*, align 1
	store i8* %19, i8** %20, align 1
	%21 = load i8*, i8** %20, align 1
	%22 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.s, i32 0, i32 0), i8* %21)
